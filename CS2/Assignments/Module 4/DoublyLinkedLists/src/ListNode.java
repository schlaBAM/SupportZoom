public class ListNode {
    ...
    public void printListFromHere() {
        ...
        while (currNode != null) {
            ...
            if(currNode.prev != null){
                System.out.println("\t\tprevNode: " + currNode.prev.data.url);
            }
    ...
    public ListNode removeFirstNode() {
        ...
        // just become null)
        next.prev = null; // remove prev reference to non-existing node
        return next;
    }
    ...
    public String concatenate(){
        String result = "Current list order:\n\t";

        ListNode currentNode = this;

        while(currentNode != null){
            result += currentNode.data.url;
    ...
    public ListNode reverse(){
        ...
        // start list off / point in opposite direction
        ListNode tail = currentNode;
        tail.next = currentNode.prev;
        tail.prev = null;
        currentNode = currentNode.next;
