...
public class TestUI {
    ...
    TestUI(BibliographyDatabase database) {}
        ...
        do {
            ...
            switch (inputNumber) {
                ...
                case 2:
                    ...
                    int issueSize = journals.getAvailableIssues(journalNum);

                    System.out.println("What issue would you like to place the article in?\n" +
                            "You can choose a number from 0 and " + issueSize);

                    int issueNum = getInput();

                    if (inputNumber < 0 && inputNumber > issueSize) {
                        System.out.println("Chose invalid number. Selecting journal 0 by default.");
                        journalNum = 0; //no fucking around here
                    } else {
                        journalNum = inputNumber;
